    ...
    render() {
        ...
        return (React.createElement(react_native_1.View, { style: styles.container },
            status === PinCode_1.PinStatus.choose &&
                React.createElement(PinCodeChoose_1.default, { storePin: this.props.storePin || null, titleEnter: this.props.titleChoose || '1 - Enter a PIN Code', subtitleEnter: this.props.subtitleChoose || 'to keep your information secure', titleConfirm: this.props.titleConfirm || '2 - Confirm your PIN Code', subtitleConfirm: this.props.subtitleConfirm || '' }),
